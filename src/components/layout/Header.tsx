        ...
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <Sheet>
            <SheetTrigger
              ...
              className="flex h-10 w-10 items-center justify-center rounded-sm text-cream transition-colors hover:text-gold md:hidden cursor-pointer"
            >
              <Menu className="h-5 w-5" />
            </SheetTrigger>
            <SheetContent side="right" className="border-border bg-obsidian-raised">
              ...
              <div className="mt-auto flex items-center gap-2 px-4 pb-6 text-xs text-muted-foreground">
